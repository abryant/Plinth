...
public class ExpressionListRule extends Rule<ParseType>
{
  ...
  private static final Production<ParseType> CONTINUATION_PRODUCTION       = new Production<ParseType>(ParseType.EXPRESSION_LIST, ParseType.COMMA, ParseType.CONDITIONAL_EXPRESSION);
  private static final Production<ParseType> CONTINUATION_QNAME_PRODUCTION = new Production<ParseType>(ParseType.EXPRESSION_LIST, ParseType.COMMA, ParseType.QNAME_OR_LESS_THAN_EXPRESSION);
