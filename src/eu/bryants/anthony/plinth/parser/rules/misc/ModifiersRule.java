...
public class ModifiersRule extends Rule<ParseType>
{
  ...
  {
    super(ParseType.MODIFIERS, START_FINAL_PRODUCTION, START_IMMUTABLE_PRODUCTION, START_MUTABLE_PRODUCTION, START_NATIVE_PRODUCTION, START_NATIVE_NAME_PRODUCTION, START_SELFISH_PRODUCTION, START_SINCE_PRODUCTION, START_STATIC_PRODUCTION,
                                     FINAL_PRODUCTION,       IMMUTABLE_PRODUCTION,       MUTABLE_PRODUCTION,       NATIVE_PRODUCTION,       NATIVE_NAME_PRODUCTION,       SELFISH_PRODUCTION,       SINCE_PRODUCTION,       STATIC_PRODUCTION);
  }
  ...
  public Object match(Production<ParseType> production, Object[] args) throws ParseException
  {
    ...
    if (production == START_MUTABLE_PRODUCTION)
    {
      return new ParseList<Modifier>(new Modifier(ModifierType.MUTABLE, (LexicalPhrase) args[0]), (LexicalPhrase) args[0]);
    }
    ...
    if (production == START_SELFISH_PRODUCTION)
    {
      return new ParseList<Modifier>(new Modifier(ModifierType.SELFISH, (LexicalPhrase) args[0]), (LexicalPhrase) args[0]);
    }
    ...
    if (production == MUTABLE_PRODUCTION)
    {
      @SuppressWarnings("unchecked")
      ParseList<Modifier> list = (ParseList<Modifier>) args[0];
      Modifier modifier = new Modifier(ModifierType.MUTABLE, (LexicalPhrase) args[1]);
      list.addLast(modifier, LexicalPhrase.combine(list.getLexicalPhrase(), modifier.getLexicalPhrase()));
      return list;
    }
    ...
    if (production == SELFISH_PRODUCTION)
    {
      @SuppressWarnings("unchecked")
      ParseList<Modifier> list = (ParseList<Modifier>) args[0];
      Modifier modifier = new Modifier(ModifierType.SELFISH, (LexicalPhrase) args[1]);
      list.addLast(modifier, LexicalPhrase.combine(list.getLexicalPhrase(), modifier.getLexicalPhrase()));
      return list;
    }
