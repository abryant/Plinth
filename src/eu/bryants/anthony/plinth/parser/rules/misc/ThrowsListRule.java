...
public class ThrowsListRule extends Rule<ParseType>
{
  ...
  private static final Production<ParseType> START_UNCHECKED_PRODUCTION = new Production<ParseType>(ParseType.UNCHECKED_KEYWORD, ParseType.QNAME);
  private static final Production<ParseType> CONTINUE_PRODUCTION           = new Production<ParseType>(ParseType.THROWS_LIST, ParseType.COMMA, ParseType.QNAME);
  private static final Production<ParseType> CONTINUE_UNCHECKED_PRODUCTION = new Production<ParseType>(ParseType.THROWS_LIST, ParseType.COMMA, ParseType.UNCHECKED_KEYWORD, ParseType.QNAME);
  ...
  public Object match(Production<ParseType> production, Object[] args) throws ParseException
  {
    if (production == START_PRODUCTION)
    {
      ...
      NamedType type = new NamedType(false, false, qname, qname.getLexicalPhrase());
