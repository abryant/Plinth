...
define protected {%RTTI*, %VFT*} @plinth_core_find_super_type(%TypeSearchList* %typeSearchList, %RTTI* %thisRTTI, %RTTI* %searchRTTI, %TypeArgumentMapper* %searchTypeMapper) {
entry:
...
searchLoop:
  ...
  %match = call i1 @plinth_check_type_matches(%RTTI* %rtti, %RTTI* %searchRTTI, %TypeArgumentMapper* %thisTypeArgumentMapper, %TypeArgumentMapper* %searchTypeMapper, i1 true, i1 true)
...
; If %ignoreTypeModifiers is true, the nullability and data-immutability of the top-level type being checked are ignored.
...
define protected i1 @plinth_check_type_matches(%RTTI* %queryType, %RTTI* %specType, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 %ignoreTypeModifiers, i1 %looselyMatchWildcards) {
entry:
  %sortQueryPtr = getelementptr %RTTI* %queryType, i32 0, i32 0
  %sortSpecPtr = getelementptr %RTTI* %specType, i32 0, i32 0
...
replaceQueryTypeArgument:
  %replacedQueryTypeParameter = bitcast %RTTI* %queryType to {i8, i32, i1, i1, i32}*
  %queryReplaceTypeParameterNullabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %replacedQueryTypeParameter, i32 0, i32 2
  %queryReplaceTypeParameterImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %replacedQueryTypeParameter, i32 0, i32 3
  ...
  %replacedQueryIndexPtr = getelementptr {i8, i32, i1, i1, i32}* %replacedQueryTypeParameter, i32 0, i32 4
...
replaceSpecTypeArgument:
  %replacedSpecTypeParameter = bitcast %RTTI* %specType to {i8, i32, i1, i1, i32}*
  %specReplaceTypeParameterNullabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %replacedSpecTypeParameter, i32 0, i32 2
  %specReplaceTypeParameterImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %replacedSpecTypeParameter, i32 0, i32 3
  ...
  %replacedSpecIndexPtr = getelementptr {i8, i32, i1, i1, i32}* %replacedSpecTypeParameter, i32 0, i32 4
...
checkSorts:
  ...
  %realQuerySortPtr = getelementptr %RTTI* %realQueryType, i32 0, i32 0
  %realSpecSortPtr = getelementptr %RTTI* %realSpecType, i32 0, i32 0
...
object:
  %queryObject = bitcast %RTTI* %realQueryType to {i8, i32, i1, i1}*
  %specObject = bitcast %RTTI* %realSpecType to {i8, i32, i1, i1}*
  %queryObjectNullabilityPtr = getelementptr {i8, i32, i1, i1}* %queryObject, i32 0, i32 2
  %queryObjectImmutabilityPtr = getelementptr {i8, i32, i1, i1}* %queryObject, i32 0, i32 3
  %specObjectNullabilityPtr = getelementptr {i8, i32, i1, i1}* %specObject, i32 0, i32 2
  %specObjectImmutabilityPtr = getelementptr {i8, i32, i1, i1}* %specObject, i32 0, i32 3
...
primitive:
  %queryPrimitive = bitcast %RTTI* %realQueryType to {i8, i32, i1, i8}*
  %specPrimitive = bitcast %RTTI* %realSpecType to {i8, i32, i1, i8}*
  %queryPrimitiveNullabilityPtr = getelementptr {i8, i32, i1, i8}* %queryPrimitive, i32 0, i32 2
  %queryPrimitiveIdPtr = getelementptr {i8, i32, i1, i8}* %queryPrimitive, i32 0, i32 3
  %specPrimitiveNullabilityPtr = getelementptr {i8, i32, i1, i8}* %specPrimitive, i32 0, i32 2
  %specPrimitiveIdPtr = getelementptr {i8, i32, i1, i8}* %specPrimitive, i32 0, i32 3
...
array:
  %queryArray = bitcast %RTTI* %realQueryType to {i8, i32, i1, i1, %RTTI*}*
  %specArray = bitcast %RTTI* %realSpecType to {i8, i32, i1, i1, %RTTI*}*
  %queryArrayNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %queryArray, i32 0, i32 2
  %queryArrayImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %queryArray, i32 0, i32 3
  %specArrayNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specArray, i32 0, i32 2
  %specArrayImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specArray, i32 0, i32 3
...
arrayContinue:
  %queryArrayBaseTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %queryArray, i32 0, i32 4
  %specArrayBaseTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specArray, i32 0, i32 4
  %queryArrayBaseType = load %RTTI** %queryArrayBaseTypePtr
  %specArrayBaseType = load %RTTI** %specArrayBaseTypePtr
  %arrayResult = call i1 @plinth_check_type_matches(%RTTI* %queryArrayBaseType, %RTTI* %specArrayBaseType, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 false, i1 false)
  ret i1 %arrayResult

tuple:
  %queryTuple = bitcast %RTTI* %realQueryType to {i8, i32, i1, i32, [0 x %RTTI*]}*
  %specTuple = bitcast %RTTI* %realSpecType to {i8, i32, i1, i32, [0 x %RTTI*]}*
  %queryTupleNullabilityPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %queryTuple, i32 0, i32 2
  %queryTupleNumSubTypesPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %queryTuple, i32 0, i32 3
  %specTupleNullabilityPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specTuple, i32 0, i32 2
  %specTupleNumSubTypesPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specTuple, i32 0, i32 3
...
tupleLoop:
  ...
  %queryTupleSubTypePtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %queryTuple, i32 0, i32 4, i32 %tupleLoopCounter
  %specTupleSubTypePtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specTuple, i32 0, i32 4, i32 %tupleLoopCounter
  %queryTupleSubType = load %RTTI** %queryTupleSubTypePtr
  %specTupleSubType = load %RTTI** %specTupleSubTypePtr
  %tupleElementComparison = call i1 @plinth_check_type_matches(%RTTI* %queryTupleSubType, %RTTI* %specTupleSubType, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 false, i1 false)
...
function:
  %queryFunction = bitcast %RTTI* %realQueryType to {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}*
  %specFunction = bitcast %RTTI* %realSpecType to {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}*
  %queryFunctionNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %queryFunction, i32 0, i32 2
  %queryFunctionImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %queryFunction, i32 0, i32 3
  %queryFunctionNumParametersPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %queryFunction, i32 0, i32 5
  %specFunctionNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specFunction, i32 0, i32 2
  %specFunctionImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specFunction, i32 0, i32 3
  %specFunctionNumParametersPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specFunction, i32 0, i32 5
...
functionReturnTypeCheck:
  %queryFunctionReturnTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %queryFunction, i32 0, i32 4
  %specFunctionReturnTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specFunction, i32 0, i32 4
  %queryFunctionReturnType = load %RTTI** %queryFunctionReturnTypePtr
  %specFunctionReturnType = load %RTTI** %specFunctionReturnTypePtr
  %functionEqualReturnTypes = call i1 @plinth_check_type_matches(%RTTI* %queryFunctionReturnType, %RTTI* %specFunctionReturnType, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 false, i1 false)
...
functionLoop:
  ...
  %queryFunctionParameterTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %queryFunction, i32 0, i32 6, i32 %functionLoopCounter
  %specFunctionParameterTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specFunction, i32 0, i32 6, i32 %functionLoopCounter
  ...
  %functionElementComparison = call i1 @plinth_check_type_matches(%RTTI* %queryFunctionParameterType, %RTTI* %specFunctionParameterType, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 false, i1 false)
...
named:
  %queryNamed = bitcast %RTTI* %realQueryType to {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}*
  %specNamed = bitcast %RTTI* %realSpecType to {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}*
  %queryNamedNullabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %queryNamed, i32 0, i32 2
  %queryNamedImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %queryNamed, i32 0, i32 3
  %queryNamedNumArgumentsPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %queryNamed, i32 0, i32 5, i32 0
  %specNamedNullabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specNamed, i32 0, i32 2
  %specNamedImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specNamed, i32 0, i32 3
  %specNamedNumArgumentsPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specNamed, i32 0, i32 5, i32 0
...
nameLengthCheck:
  %queryNamedNamePtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %queryNamed, i32 0, i32 4
  %specNamedNamePtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specNamed, i32 0, i32 4
...
typeArgumentLoop:
  ...
  %queryTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %queryNamed, i32 0, i32 5, i32 1, i32 %typeArgumentLoopCounter
  %specTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specNamed, i32 0, i32 5, i32 1, i32 %typeArgumentLoopCounter
  %queryTypeArgument = load %RTTI** %queryTypeArgumentPtr
  %specTypeArgument = load %RTTI** %specTypeArgumentPtr
  %typeArgumentsEquivalent = call i1 @plinth_check_type_matches(%RTTI* %queryTypeArgument, %RTTI* %specTypeArgument, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 false, i1 %looselyMatchWildcards)
...
typeParameter:
  %queryTypeParameter = bitcast %RTTI* %realQueryType to {i8, i32, i1, i1, i32}*
  %specTypeParameter = bitcast %RTTI* %realSpecType to {i8, i32, i1, i1, i32}*
  %queryTypeParameterNullabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %queryTypeParameter, i32 0, i32 2
  %queryTypeParameterImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %queryTypeParameter, i32 0, i32 3
  %queryTypeParameterIndexPtr = getelementptr {i8, i32, i1, i1, i32}* %queryTypeParameter, i32 0, i32 4
  %specTypeParameterNullabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %specTypeParameter, i32 0, i32 2
  %specTypeParameterImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %specTypeParameter, i32 0, i32 3
  %specTypeParameterIndexPtr = getelementptr {i8, i32, i1, i1, i32}* %specTypeParameter, i32 0, i32 4
...
wildcard:
  %queryWildcard = bitcast %RTTI* %realQueryType to {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}*
  %specWildcard = bitcast %RTTI* %realSpecType to {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}*
  %queryWildcardNullabilityPtr   = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %queryWildcard, i32 0, i32 2
  %queryWildcardImmutabilityPtr  = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %queryWildcard, i32 0, i32 3
  %queryWildcardNumSuperTypesPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %queryWildcard, i32 0, i32 4
  %queryWildcardNumSubTypesPtr   = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %queryWildcard, i32 0, i32 5
  %specWildcardNullabilityPtr   = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specWildcard, i32 0, i32 2
  %specWildcardImmutabilityPtr  = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specWildcard, i32 0, i32 3
  %specWildcardNumSuperTypesPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specWildcard, i32 0, i32 4
  %specWildcardNumSubTypesPtr   = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specWildcard, i32 0, i32 5
  ...
  %wildcardNullabilityImmutability = and i1 %wildcardEqualNullability, %wildcardEqualImmutability
  %wildcardTypeModifiersMatch = or i1 %wildcardNullabilityImmutability, %ignoreTypeModifiers
...
wildcardCheckLoop:
  ...
  %queryWildcardRTTIPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %queryWildcard, i32 0, i32 6, i32 %wildcardIndex
  %specWildcardRTTIPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specWildcard, i32 0, i32 6, i32 %wildcardIndex
  %queryWildcardRTTI = load %RTTI** %queryWildcardRTTIPtr
  %specWildcardRTTI = load %RTTI** %specWildcardRTTIPtr
  %wildcardTypesEquivalent = call i1 @plinth_check_type_matches(%RTTI* %queryWildcardRTTI, %RTTI* %specWildcardRTTI, %TypeArgumentMapper* %queryMapper, %TypeArgumentMapper* %specMapper, i1 false, i1 %looselyMatchWildcards)
...
array:
  %arrayRTTI = bitcast %RTTI* %type to {i8, i32, i1, i1, %RTTI*}*
  %arrayBaseRTTIPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %arrayRTTI, i32 0, i32 4
...
createSpecialisedArray:
  %arrayRTTISize = ptrtoint {i8, i32, i1, i1, %RTTI*}* getelementptr ({i8, i32, i1, i1, %RTTI*}* null, i32 1) to i32
  %arrayAlloc = call i8* @calloc(i32 %arrayRTTISize, i32 1)
  %specialisedArray = bitcast i8* %arrayAlloc to {i8, i32, i1, i1, %RTTI*}*
  %arraySortIdPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specialisedArray, i32 0, i32 0
  store i8 3, i8* %arraySortIdPtr
  %arraySize = ptrtoint i8** getelementptr (i8** null, i32 1) to i32 ; the size of an arbitrary pointer
  %arraySizePtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specialisedArray, i32 0, i32 1
  store i32 %arraySize, i32* %arraySizePtr
  %oldArrayNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %arrayRTTI, i32 0, i32 2
  %arrayNullability = load i1* %oldArrayNullabilityPtr
  %arrayNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specialisedArray, i32 0, i32 2
  store i1 %arrayNullability, i1* %arrayNullabilityPtr
  %oldArrayImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %arrayRTTI, i32 0, i32 3
  %arrayImmutability = load i1* %oldArrayImmutabilityPtr
  %arrayImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specialisedArray, i32 0, i32 3
  store i1 %arrayImmutability, i1* %arrayImmutabilityPtr
  %newArrayBaseRTTIPtr = getelementptr {i8, i32, i1, i1, %RTTI*}* %specialisedArray, i32 0, i32 4
  store %RTTI* %specialisedArrayBaseRTTI, %RTTI** %newArrayBaseRTTIPtr
  %castedSpecialisedArray = bitcast {i8, i32, i1, i1, %RTTI*}* %specialisedArray to %RTTI*
...
tuple:
  ...
  ; }
  ; return tupleRTTI
  %tupleNumElementsPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %tupleRTTI, i32 0, i32 3
...
tupleCheckLoop:
  ...
  %tupleSubTypeRTTIPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %tupleRTTI, i32 0, i32 4, i32 %tupleCheckLoopIndex
...
createSpecialisedTuple:
  %tupleRTTISizePtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* null, i32 0, i32 4, i32 %tupleNumElements
  %tupleRTTISize = ptrtoint %RTTI** %tupleRTTISizePtr to i32
  %tupleAlloc = call i8* @calloc(i32 %tupleRTTISize, i32 1)
  %specialisedTuple = bitcast i8* %tupleAlloc to {i8, i32, i1, i32, [0 x %RTTI*]}*
  %tupleSortIdPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 0
  store i8 4, i8* %tupleSortIdPtr
  %tupleSizePtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 1
  store i32 123456789, i32* %tupleSizePtr ; TODO: this field needs to be removed, as it is never used and there is no way of calculating it at run-time
  %oldTupleNullabilityPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %tupleRTTI, i32 0, i32 2
  %tupleNullability = load i1* %oldTupleNullabilityPtr
  %tupleNullabilityPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 2
  store i1 %tupleNullability, i1* %tupleNullabilityPtr
  %newTupleNumElementsPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 3
  store i32 %tupleNumElements, i32* %newTupleNumElementsPtr
  %newTupleElementPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 4, i32 %tupleCheckLoopIndex
...
tupleCopyPreviousElementsLoop:
  ...
  %oldTupleElementPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %tupleRTTI, i32 0, i32 4, i32 %tupleCopyLoopIndex
  %copiedTupleElement = load %RTTI** %oldTupleElementPtr
  %copiedTupleElementPtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 4, i32 %tupleCopyLoopIndex
...
tupleSpecialiseSubTypesLoop:
  ...
  %oldTupleSubTypePtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %tupleRTTI, i32 0, i32 4, i32 %tupleSpecialiseLoopIndex
  ...
  %newTupleSubTypePtr = getelementptr {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple, i32 0, i32 4, i32 %tupleSpecialiseLoopIndex
...
returnSpecialisedTuple:
  %castedSpecialisedTuple = bitcast {i8, i32, i1, i32, [0 x %RTTI*]}* %specialisedTuple to %RTTI*
...
function:
  ...
  %functionReturnTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 4
  ...
  %functionNumParamsPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 5
...
checkFunctionParamTypesLoop:
  ...
  %functionParamTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 6, i32 %checkFunctionParamTypesIndex
...
createSpecialisedFunction:
  ...
  %functionRTTISizePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* null, i32 0, i32 6, i32 %functionNumParams
  %functionRTTISize = ptrtoint %RTTI** %functionRTTISizePtr to i32
  %functionAlloc = call i8* @calloc(i32 %functionRTTISize, i32 1)
  %specialisedFunction = bitcast i8* %functionAlloc to {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}*
  %functionSortIdPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 0
  store i8 5, i8* %functionSortIdPtr
  %functionSize = ptrtoint {i8*, i8*, i8*}* getelementptr ({i8*, i8*, i8*}* null, i32 1) to i32 ; the size of a tuple of three pointers
  %functionSizePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 1
  store i32 %functionSize, i32* %functionSizePtr
  %oldFunctionNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 2
  %functionNullability = load i1* %oldFunctionNullabilityPtr
  %newFunctionNullabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 2
  store i1 %functionNullability, i1* %newFunctionNullabilityPtr
  %oldFunctionImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 3
  %functionImmutability = load i1* %oldFunctionImmutabilityPtr
  %newFunctionImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 3
  store i1 %functionImmutability, i1* %newFunctionImmutabilityPtr
  %newFunctionReturnTypePtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 4
  store %RTTI* %specialisedFunctionReturnType, %RTTI** %newFunctionReturnTypePtr
  %newFunctionNumParamsPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 5
...
copyFirstDifferingFunctionParam:
  %firstDifferingFunctionParamPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 6, i32 %firstDifferingFunctionParamIndex
...
copyFunctionPreviousParams:
  ...
  %oldFunctionParamPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 6, i32 %functionCopyPreviousParamsIndex
  %copiedFunctionParam = load %RTTI** %oldFunctionParamPtr
  %copiedFunctionParamPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 6, i32 %functionCopyPreviousParamsIndex
...
specialiseFunctionParamsLoop:
  ...
  %nonSpecialisedFunctionParamPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %functionRTTI, i32 0, i32 6, i32 %specialiseFunctionParamsIndex
  ...
  %newFunctionParamPtr = getelementptr {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction, i32 0, i32 6, i32 %specialiseFunctionParamsIndex
...
returnSpecialisedFunction:
  %castedSpecialisedFunction = bitcast {i8, i32, i1, i1, %RTTI*, i32, [0 x %RTTI*]}* %specialisedFunction to %RTTI*
...
named:
  ...
  %namedTypeNumArgumentsPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 5, i32 0
...
checkNamedTypeArgumentsLoop:
  ...
  %namedTypeArgumentRTTIPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 5, i32 1, i32 %namedTypeCheckLoopIndex
...
specialiseNamedType:
  %namedRTTISizePtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* null, i32 0, i32 5, i32 1, i32 %namedTypeNumArguments
  %namedRTTISize = ptrtoint %RTTI** %namedRTTISizePtr to i32
  %namedAlloc = call i8* @calloc(i32 %namedRTTISize, i32 1)
  %specialisedNamed = bitcast i8* %namedAlloc to {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}*
  %namedSortIdPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 0
  store i8 %sort, i8* %namedSortIdPtr
  %namedSize = ptrtoint i8** getelementptr (i8** null, i32 1) to i32 ; the size of an arbitrary pointer
  %namedSizePtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 1
  store i32 %namedSize, i32* %namedSizePtr
  %oldNamedNullabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 2
  %namedNullability = load i1* %oldNamedNullabilityPtr
  %newNamedNullabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 2
  store i1 %namedNullability, i1* %newNamedNullabilityPtr
  %oldNamedImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 3
  %namedImmutability = load i1* %oldNamedImmutabilityPtr
  %newNamedImmutabilityPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 3
  store i1 %namedImmutability, i1* %newNamedImmutabilityPtr
  %oldNamedNamePtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 4
  %namedName = load %RawString** %oldNamedNamePtr
  %newNamedNamePtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 4
  store %RawString* %namedName, %RawString** %newNamedNamePtr
  %newNamedTypeNumArgumentsPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 5, i32 0
  store i32 %namedTypeNumArguments, i32* %newNamedTypeNumArgumentsPtr
  %newNamedTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 5, i32 1, i32 %namedTypeCheckLoopIndex
...
copyPreviousNamedTypeArgumentsLoop:
  ...
  %oldCopyNamedTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 5, i32 1, i32 %namedCopyIndex
  %copiedNamedTypeArgument = load %RTTI** %oldCopyNamedTypeArgumentPtr
  %newCopyNamedTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 5, i32 1, i32 %namedCopyIndex
...
specialiseNamedTypeArgumentsLoop:
  ...
  %oldNamedTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %namedRTTI, i32 0, i32 5, i32 1, i32 %namedSpecialiseIndex
  ...
  %specialisedNamedTypeArgumentPtr = getelementptr {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed, i32 0, i32 5, i32 1, i32 %namedSpecialiseIndex
...
returnSpecialisedNamed:
  %castedSpecialisedNamed = bitcast {i8, i32, i1, i1, %RawString*, %TypeArgumentMapper}* %specialisedNamed to %RTTI*
  ret %RTTI* %castedSpecialisedNamed

typeParameter:
  %typeParameterRTTI = bitcast %RTTI* %type to {i8, i32, i1, i1, i32}*
  %typeParameterIndexPtr = getelementptr {i8, i32, i1, i1, i32}* %typeParameterRTTI, i32 0, i32 4
...
returnSpecialisedTypeParameter:
  %typeParamNullabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %typeParameterRTTI, i32 0, i32 2
  %typeParamNullability = load i1* %typeParamNullabilityPtr
  %typeParamImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32}* %typeParameterRTTI, i32 0, i32 3
...
wildcard:
  %wildcardRTTI = bitcast %RTTI* %type to {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}*
  ; try not to waste any allocations here - we use an algorithm extremely similar to the one used for tuples above
  %wildcardNumSuperTypesPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 4
  %wildcardNumSubTypesPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 5
...
checkWildcardTypesLoop:
  ...
  %wildcardTypeRTTIPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 6, i32 %wildcardCheckLoopIndex
...
specialiseWildcardType:
  %wildcardRTTISizePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* null, i32 0, i32 6, i32 %wildcardNumSubTypes
  %wildcardRTTISize = ptrtoint %RTTI** %wildcardRTTISizePtr to i32
  %wildcardAlloc = call i8* @calloc(i32 %wildcardRTTISize, i32 1)
  %specialisedWildcard = bitcast i8* %wildcardAlloc to {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}*
  %wildcardSortIdPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 0
  store i8 %sort, i8* %wildcardSortIdPtr
  %wildcardSize = ptrtoint i8** getelementptr (i8** null, i32 1) to i32 ; the size of an arbitrary pointer
  %wildcardSizePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 1
  store i32 %wildcardSize, i32* %wildcardSizePtr
  %oldWildcardNullabilityPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 2
  %wildcardNullability = load i1* %oldWildcardNullabilityPtr
  %newWildcardNullabilityPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 2
  store i1 %wildcardNullability, i1* %newWildcardNullabilityPtr
  %oldWildcardImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 3
  %wildcardImmutability = load i1* %oldWildcardImmutabilityPtr
  %newWildcardImmutabilityPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 3
  store i1 %wildcardImmutability, i1* %newWildcardImmutabilityPtr
  %newWildcardNumSuperTypesPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 4
  store i32 %wildcardNumSuperTypes, i32* %newWildcardNumSuperTypesPtr
  %newWildcardNumSubTypesPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 5
  store i32 %wildcardNumSubTypes, i32* %newWildcardNumSubTypesPtr
  %newWildcardTypeRTTIPtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 6, i32 %wildcardCheckLoopIndex
...
copyPreviousWildcardTypesLoop:
  ...
  %oldCopyWildcardTypePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 6, i32 %wildcardCopyIndex
  %copiedWildcardType = load %RTTI** %oldCopyWildcardTypePtr
  %newCopyWildcardTypePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 6, i32 %wildcardCopyIndex
...
specialiseWildcardTypesLoop:
  ...
  %oldWildcardTypePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %wildcardRTTI, i32 0, i32 6, i32 %wildcardSpecialiseIndex
  ...
  %newWildcardTypePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard, i32 0, i32 6, i32 %wildcardSpecialiseIndex
...
returnSpecialisedWildcard:
  %castedSpecialisedWildcard = bitcast {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* %specialisedWildcard to %RTTI*
...
alterWildcard:
  ...
  %wildcardNumSubTypes = load i32* %wildcardNumSubTypesPtr
  %wildcardTotalTypes = add i32 %wildcardNumSuperTypes, %wildcardNumSubTypes
  %wildcardSizePtr = getelementptr {i8, i32, i1, i1, i32, i32, [0 x %RTTI*]}* null, i32 0, i32 6, i32 %wildcardTotalTypes
